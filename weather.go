...
func main(){
	...
	res, err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=mandi&APPID=ee57e340e20c6252600d725cef70262c")
	...
	image := canvas.NewImageFromFile("weathet.png")
